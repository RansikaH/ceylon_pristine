                ...
                <div class="card-body">
                    <div class="row align-items-center g-0">
                        ...
                        <div class="col-md-6 text-center p-4 p-md-5 d-flex flex-column align-items-center justify-content-center">
                            @php
                                $imgPath = $product->image ? 'storage/' . $product->image : null;
                            ...
                            <div class="position-relative w-100" style="max-width:340px;">
                                <img src="{{ $imageSrc }}" alt="{{ $product->name }}" class="img-fluid rounded-3 shadow border border-2 border-light product-img-hover" style="max-height:320px; object-fit:cover; background:#f8f9fa; padding: 8px;">
